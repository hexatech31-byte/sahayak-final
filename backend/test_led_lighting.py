...
req = {
    'title': 'LED Lighting',
    'description': 'Procurement of LED lighting systems for general lighting applications.',
    'category': 'Electrical',
    'quantity': '500 Units',
    'budget': '₹ 10,00,000',
...
query = 'LED Lighting Procurement of LED lighting systems for general lighting applications. Electrical general lighting Indoor / office'

print("Testing LED Lighting...")
print(f"Query: {query}")
print()
